...
└── tests/
    ...
    └── test_fpinn_loss.py
            unit tests certifying that fpinn_loss restricts the
            residual average to the interior index set
            I_h = {0, ..., floor(N/2)}, matching the support of
            Theorem 8.2 of the paper
```
